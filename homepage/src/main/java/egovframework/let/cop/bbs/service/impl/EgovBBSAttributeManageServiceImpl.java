...
public class EgovBBSAttributeManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSAttributeManageService {
     ...
     * 등록된 게시판 속성정보를 삭제한다.
     *
     * @see egovframework.let.cop.bbs.practiceService.service.EgovBBSAttributeManageService#deleteBBSMasterInf(egovframework.let.cop.bbs.brd.service.BoardMaster)
     */
    @Override
     ...
     * 신규 게시판 속성정보를 생성한다.
     *
     * @see egovframework.let.cop.bbs.practiceService.service.EgovBBSAttributeManageService#insertBBSMastetInf(egovframework.let.cop.bbs.brd.service.BoardMaster)
     */
    @Override
     ...
     *
     * @see egovframework.let.cop.bbs.practiceService.service.EgovBBSAttributeManageService#selectAllBBSMasteInf(egovframework.let.cop.bbs.brd.service.BoardMasterVO)
     */
    @Override
     ...
     *
     * @see egovframework.let.cop.bbs.practiceService.service.EgovBBSAttributeManageService#selectBBSMasterInf(egovframework.let.cop.bbs.brd.service.BoardMasterVO)
     */
    @Override
     ...
     * 게시판 속성 정보의 목록을 조회 한다.
     *
     * @see egovframework.let.cop.bbs.practiceService.service.EgovBBSAttributeManageService#selectBBSMasterInfs(egovframework.let.cop.bbs.brd.service.BoardMasterVO)
     */
    @Override
     ...
     * 게시판 속성정보를 수정한다.
     *
     * @see egovframework.let.cop.bbs.practiceService.service.EgovBBSAttributeManageService#updateBBSMasterInf(egovframework.let.cop.bbs.brd.service.BoardMaster)
     */
    @Override
     ...
     * 템플릿의 유효여부를 점검한다.
     *
     * @see egovframework.let.cop.bbs.practiceService.service.EgovBBSAttributeManageService#validateTemplate(egovframework.let.cop.bbs.brd.service.BoardMasterVO)
     */
    @Override
