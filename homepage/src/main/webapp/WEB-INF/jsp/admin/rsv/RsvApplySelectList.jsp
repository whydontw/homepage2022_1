				...
				<div id="bbs_wrap">
					...
					<div class="excelUploadBox">
						...
						<form action="/admin/rsv/excelUpload.json" id="excelForm" name="excelForm" enctype="multipart/form-data" method="post">
							...
							<a href="/excel/rqtExcel_sample.xls" class="btn" download>엑셀 업로드 샘플 다운로드</a><br>
							<label for="registerExcelFile">파일첨부</label>
							<input type="file" id="registerExcelFile" name="registerExcelFile" class="upload-hidden">
