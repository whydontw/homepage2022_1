			...
			<div id="bbs_wrap">
				<div class="board_view">
					...
					<dl class="info_view">
						<dt>운영일자</dt>
						<dd>
							<c:out value="${reservation.useBeginDt }"/> ~ <c:out value="${reservation.useEndDt }"/>
						</dd>
						<dt>운영시간</dt>
						<dd>
							<c:out value="${reservation.useBeginTime }"/> ~ <c:out value="${reservation.useEndTime }"/>
						</dd>
						<dt>신청기간</dt>
						<dd>
							<c:out value="${reservation.reqstBgnde }"/> ~ <c:out value="${reservation.reqstEndde }"/>
						</dd>
						<dt>신청가능한 인원</dt>
						<dd>
							<c:out value="${reservation.maxAplyCnt }"/>
						</dd>
					</dl>
					<dl class="info_view2">
						<dt>작성자 ID</dt>
						<dd>
							<c:out value="${reservation.frstRegisterId }"/>
						</dd>
						<dt>작성일</dt>
						<dd>
							<fmt:formatDate value="${reservation.frstRegistPnttm }" pattern="yyyy-MM-dd"/>
						</dd>
					</dl>
					<div class="view_cont">
