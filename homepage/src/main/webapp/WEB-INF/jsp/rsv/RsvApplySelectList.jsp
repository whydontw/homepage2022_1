		...
		<div class="container">
			<div id="contents">
				...
				<div id="bbs_wrap">
					...
					<div class="bbs_list">
						<table class="list_table" style="color: black;">
							<thead>
								<tr>
							...
							<tbody>
								<c:forEach var="result" items="${resultList }" varStatus="status">
									<tr>
										...
										<td><c:url var="rsvViewUrl" value="/rsv/rsvSelect.do${_BASE_PARAM }">
...
$(document).ready(function(){
	//페이지 내에 삭제 버튼이 여러개 생기기 때문에 btn-del을 id가 아닌 class로 지정함
